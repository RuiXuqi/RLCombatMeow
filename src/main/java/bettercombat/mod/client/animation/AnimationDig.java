 ...
 */
public class AnimationDig implements IAnimation {
    ...
    private void animateSwing(boolean rightHanded, float swingProgress, float partialTick, BetterCombatHand hand) {
        ...
        GlStateManager.translate(
                /* X */ 0.8F * i * moveRight * hand.moveRightVariance,
                /* Y */ 0.9F * 1.25F * moveUp * hand.moveUpVariance,
                /* Z */ 0.4F * 0.5F * moveClose * hand.moveCloseVariance);
        GlStateManager.rotate(1.6F * rotateUp * hand.rotateUpVariance, 1.0F, 0.0F, 0.0F);
        GlStateManager.rotate(0.4F * i * rotateCounterClockwise * hand.rotateCounterClockwiseVariance, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(1.2F * i * rotateLeft * hand.rotateLeftVariance, 0.0F, 0.0F, 1.0F);
    }
}